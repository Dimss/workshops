...
2. Find the `Reconcile` function and leave it empty, after editing, this is how your `Reconcile` function should looks like
   ```go
   ...
   ```
3. Find the `add` function, and remove autogenerated code, after editing, this is how your `add` function should looks likes
    ```go
